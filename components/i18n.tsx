...
const UI: Record<Lang, Dict> = {
  en: {
    ...
    "pp.time": "Est. time",
    "pdf.plan": "Event plan",
    "pdf.summary": "Race summary",
    "pdf.stations": "Stations & specs",
    "pdf.run": "Run leg",
    "pdf.total": "Est. finish",
  },
  it: {
    ...
    "export.pdf": "Planimetria PDF",
    "aria.tourPlay": "Avvia sequenza",
    "aria.tourPause": "Ferma sequenza",
    "pp.time": "Tempo stimato",
    "pdf.plan": "Planimetria evento",
    "pdf.summary": "Riepilogo gara",
    "pdf.stations": "Stazioni & specifiche",
    "pdf.run": "Tratto di corsa",
    "pdf.total": "Tempo stimato",
  },
};
